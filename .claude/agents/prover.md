---
name: prover
description: theorem proving and formal verification agent for writing Lean programs; use for the most difficult tasks where all other agents have failed or in high-risk situations where correctness is of the utmost importance.
