...
gens = [
  (24) + (24)*x0*x0*x0 + (72)*x0*x0*x1 + (72)*x0*x0*x2 + (72)*x0*x1*x1 + (144)*x0*x1*x2 + (72)*x0*x2*x2 + (24)*x1*x1*x1 + (72)*x1*x1*x2 + (72)*x1*x2*x2 + (24)*x2*x2*x2 + (648)*x5*x5*x5,
  (-3/2) + (-6)*x0*x0*x0 + (18)*x0*x1*x2 + (-6)*x1*x1*x1 + (-6)*x2*x2*x2,
  (-3/2) + (-6)*x0*x0*x0 + (18)*x0*x1*x2 + (-6)*x1*x1*x1 + (-6)*x2*x2*x2,
  ...
  (-3/2) + (-6)*x0*x0*x0 + (18)*x0*x1*x2 + (-6)*x1*x1*x1 + (-6)*x2*x2*x2,
  (-3/2) + (-6)*x0*x0*x0 + (18)*x0*x1*x2 + (-6)*x1*x1*x1 + (-6)*x2*x2*x2,
  (-3/4) + (6)*x0*x0*x0 + (-9)*x0*x0*x1 + (-9)*x0*x0*x2 + (-9)*x0*x1*x1 + (36)*x0*x1*x2 + (-9)*x0*x2*x2 + (6)*x1*x1*x1 + (-9)*x1*x1*x2 + (-9)*x1*x2*x2 + (6)*x2*x2*x2,
  (3/4) + (-6)*x0*x0*x0 + (9)*x0*x0*x1 + (9)*x0*x0*x2 + (9)*x0*x1*x1 + (-36)*x0*x1*x2 + (9)*x0*x2*x2 + (-6)*x1*x1*x1 + (9)*x1*x1*x2 + (9)*x1*x2*x2 + (-6)*x2*x2*x2,
  (1),
  (-1/2),
  (-3/2),
