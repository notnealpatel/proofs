...
# This file was *autogenerated* from the file /workspace/Bp1-total-params.sage
from sage.all_cmdline import *   # import sage library

_sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_7 = Integer(7); _sage_const_3 = Integer(3); _sage_const_60 = Integer(60); _sage_const_75 = Integer(75); _sage_const_16 = Integer(16); _sage_const_6 = Integer(6); _sage_const_15 = Integer(15); _sage_const_13 = Integer(13)# Bp1: Compute total parameter count across all outer structures for M_4.
#
...
root_vals = {
    'r12': (_sage_const_2 , -_sage_const_1 , _sage_const_0 ),
    'r23': (-_sage_const_1 , _sage_const_2 , -_sage_const_1 ),
    'r34': (_sage_const_0 , -_sage_const_1 , _sage_const_2 ),
    'r13': (_sage_const_1 , _sage_const_1 , -_sage_const_1 ),
    'r24': (-_sage_const_1 , _sage_const_1 , _sage_const_1 ),
    'r14': (_sage_const_1 , _sage_const_0 , _sage_const_1 )
}
...
for j in range(_sage_const_16 ):
    ...
    for S in upper_sets:
        ...
        for k in range(_sage_const_0 , min(cf, j - s_size) + _sage_const_1 ):
            l = j - s_size - k
            if l < _sage_const_0  or l > _sage_const_6 :
                continue
    ...
    if configs:
        max_pd = max(c[_sage_const_3 ] for c in configs)
        n_configs = len(configs)
        # How many have positive param dim?
        n_parametric = sum(_sage_const_1  for c in configs if c[_sage_const_3 ] > _sage_const_0 )
        notes = ""
        if n_parametric > _sage_const_0 :
            notes = "PARAMETRIC (%d families)" % n_parametric
        print("%11d | %14d | %17d | %s" % (j, n_configs, max_pd, notes))
    else:
        print("%11d | %14d | %17d |" % (j, _sage_const_0 , _sage_const_0 ))
...
def maximize_params(remaining, max_parts, max_val=_sage_const_15 ):
    """Find partition of 'remaining' into at most max_parts parts (each 0..max_val)
    that maximizes sum of max_param_by_j[part]."""
    if remaining == _sage_const_0  or max_parts == _sage_const_0 :
        return _sage_const_0 , []
    best = _sage_const_0 
    best_parts = []
    for j in range(min(remaining, max_val), _sage_const_0 , -_sage_const_1 ):
        p = max_param_by_j[j]
        sub_best, sub_parts = maximize_params(remaining - j, max_parts - _sage_const_1 , j)
        total = p + sub_best
        if total > best:
            best = total
...
best_params, best_partition = maximize_params(_sage_const_13 , _sage_const_16 )
