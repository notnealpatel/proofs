...
# This file was *autogenerated* from the file /workspace/Bp1-verify-m3.sage
from sage.all_cmdline import *   # import sage library

_sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_3 = Integer(3); _sage_const_65 = Integer(65); _sage_const_4 = Integer(4); _sage_const_10 = Integer(10); _sage_const_11 = Integer(11); _sage_const_15 = Integer(15); _sage_const_20 = Integer(20); _sage_const_21 = Integer(21); _sage_const_6 = Integer(6); _sage_const_7 = Integer(7); _sage_const_16 = Integer(16); _sage_const_40 = Integer(40); _sage_const_8 = Integer(8); _sage_const_60 = Integer(60)# Bp1: Verify the a_j, b_j + Lemma 5.2 computation against CHL's M_3 result.
#
...
V15 = W_ring(_sage_const_2 ,_sage_const_1 )   # V_{2w1+w2} for sl_3, dim should be 15
V6 = W_ring(_sage_const_0 ,_sage_const_2 )    # V_{w2+w2} = V_{2w2} for sl_3, dim should be 6
V3 = W_ring(_sage_const_1 ,_sage_const_0 )    # V_{w1}, dim 3
...
def make_lookup(wm):
    ...
    for wt, mult in wm.items():
        coords = tuple(QQ(wt[i]) for i in range(_sage_const_3 ))
...
# e_3 = (-1/3, -1/3, 2/3)
V_wts_3 = [
    (QQ(_sage_const_2 )/_sage_const_3 , QQ(-_sage_const_1 )/_sage_const_3 , QQ(-_sage_const_1 )/_sage_const_3 ),
    (QQ(-_sage_const_1 )/_sage_const_3 , QQ(_sage_const_2 )/_sage_const_3 , QQ(-_sage_const_1 )/_sage_const_3 ),
    (QQ(-_sage_const_1 )/_sage_const_3 , QQ(-_sage_const_1 )/_sage_const_3 , QQ(_sage_const_2 )/_sage_const_3 ),
]

# sl_3 root weights:
adj3_wts = {
    'e1-e3': (QQ(_sage_const_1 ), QQ(_sage_const_0 ), QQ(-_sage_const_1 )),    # highest root
    'e1-e2': (QQ(_sage_const_1 ), QQ(-_sage_const_1 ), QQ(_sage_const_0 )),     # simple root alpha_1
    'e2-e3': (QQ(_sage_const_0 ), QQ(_sage_const_1 ), QQ(-_sage_const_1 )),     # simple root alpha_2
    'h':     (QQ(_sage_const_0 ), QQ(_sage_const_0 ), QQ(_sage_const_0 )),      # Cartan (mult 2)
    'e2-e1': (QQ(-_sage_const_1 ), QQ(_sage_const_1 ), QQ(_sage_const_0 )),
    'e3-e2': (QQ(_sage_const_0 ), QQ(-_sage_const_1 ), QQ(_sage_const_1 )),
    'e3-e1': (QQ(-_sage_const_1 ), QQ(_sage_const_0 ), QQ(_sage_const_1 )),     # lowest root
}
...
levels_3 = [
    [('e1-e3', _sage_const_1 )],                      # height 2 (highest root)
    [('e1-e2', _sage_const_1 ), ('e2-e3', _sage_const_1 )],        # height 1
    [('h', _sage_const_2 )],                           # Cartan
    [('e2-e1', _sage_const_1 ), ('e3-e2', _sage_const_1 )],        # height -1
    [('e3-e1', _sage_const_1 )],                       # height -2
]
...
def compute_proj(weight_list, l15, l6, l3):
    ...
    d15 = sum(min(cnt, l15.get(wt, _sage_const_0 )) for wt, cnt in wt_counts.items())
    d6 = sum(min(cnt, l6.get(wt, _sage_const_0 )) for wt, cnt in wt_counts.items())
    d3 = sum(min(cnt, l3.get(wt, _sage_const_0 )) for wt, cnt in wt_counts.items())
    return d15, d6, d3

j = _sage_const_0 
all_vx_wts = []
n = _sage_const_3   # dim U = dim W for M_3

print("sl_3 a_j, b_j computation:")
print("j  | root   | d15 d6 d3 | a   | b     | CHL a | CHL b")
print("-" * _sage_const_65 )

chl_a = [None, _sage_const_1 , _sage_const_4 , _sage_const_10 , _sage_const_11 , _sage_const_15 , _sage_const_20 , _sage_const_21 , _sage_const_21 ]
chl_b = [None, _sage_const_0 , -_sage_const_1 , -_sage_const_4 , -_sage_const_4 , n-_sage_const_4 , n-_sage_const_6 , _sage_const_2 *n-_sage_const_6 , _sage_const_3 *n-_sage_const_6 ]
...
rho_m3 = _sage_const_7   # dim(E_110') for M_3 at r=16: 16 - 9 = 7
r_m3 = _sage_const_16 
n_m3 = _sage_const_3 
...
for level in levels_3:
    for root_label, mult in level:
        ...
        for m in range(mult):
            ...
            a = d15 + d6
            b = n_m3 * d3 - d6
            bound = a * rho_m3**_sage_const_2  / (_sage_const_8  * j**_sage_const_2 ) + (a + b) * rho_m3 / j
