...
# This file was *autogenerated* from the file /workspace/Bp1-dimensions.sage
from sage.all_cmdline import *   # import sage library

_sage_const_2 = Integer(2); _sage_const_3 = Integer(3); _sage_const_4 = Integer(4); _sage_const_60 = Integer(60); _sage_const_1 = Integer(1); _sage_const_6 = Integer(6)# Bp1: Compute the decisive dimensions for M_4 border apolarity feasibility.
#
...
for n in [_sage_const_2 , _sage_const_3 , _sage_const_4 ]:
    ...
    dimA = n**_sage_const_2 
    dimB = n**_sage_const_2 
    dimC = n**_sage_const_2 
    dimslV = n**_sage_const_2  - _sage_const_1 
    ...
    import math
    r_koszul = _sage_const_2 *n**_sage_const_2  - int(math.ceil(math.log2(n))) - _sage_const_1 

    # dim E_110' = r - n^2
    dim_E110_prime = r_koszul - n**_sage_const_2 
    ...
    dim_S2A_star_times_B_star = binomial(n**_sage_const_2  + _sage_const_1 , _sage_const_2 ) * n**_sage_const_2 

    # (120) map target: A* tensor S^2(B*) has dimension n^2 * binom(n^2+1,2)
    dim_A_star_times_S2B_star = n**_sage_const_2  * binomial(n**_sage_const_2  + _sage_const_1 , _sage_const_2 )

    # Dual (210) map: E_110 tensor A -> Lambda^2(A) tensor B
    dim_Lambda2A_times_B = binomial(n**_sage_const_2 , _sage_const_2 ) * n**_sage_const_2 

    # For the (111) test:
    # F_110 tensor C* + F_101 tensor B* + F_011 tensor A* -> A* tensor B* tensor C*
    dim_ABC = (n**_sage_const_2 )**_sage_const_3 
    ...
    # dim V_{w1} = v
    v = n  # dim V
    dim_V_2w1_wvm1 = v**_sage_const_3  // _sage_const_2  + v**_sage_const_2  // _sage_const_2  - v
    dim_V_w2_wvm1 = v**_sage_const_3  // _sage_const_2  - v**_sage_const_2  // _sage_const_2  - v
    dim_V_w1 = v
    ...
    dim_weight_zero_slV = n - _sage_const_1 
    ...
    dim_E110 = r_koszul
    dim_dual_210_source = dim_E110 * n**_sage_const_2 
    dim_dual_210_target = binomial(n**_sage_const_2 , _sage_const_2 ) * n**_sage_const_2 

    print("  Dual (210) map (CHL formulation):")
    print("    source: E_110 tensor A = %d x %d = %d" % (dim_E110, n**_sage_const_2 , dim_dual_210_source))
    ...
    dim_111_one_term = dim_F110 * n**_sage_const_2 
    dim_111_target = n**_sage_const_6 
    print("  (111) map dimensions:")
    print("    each source term: %d x %d = %d" % (dim_F110, n**_sage_const_2 , dim_111_one_term))
    print("    total source (3 terms): %d" % (_sage_const_3  * dim_111_one_term))
    ...
    print("    number of roots (multiplicity-1 weights) = %d" % (n*(n-_sage_const_1 )))
    print("    total = %d (check: %d)" % (dim_weight_zero_slV + n*(n-_sage_const_1 ), dimslV))
    print()
    ...
    max_grass_dim = (n-_sage_const_1 )**_sage_const_2  // _sage_const_4 
    print("  Maximum Grassmannian parameter at one site: Gr(k,%d)" % (n-_sage_const_1 ))
    print("    max dim = %d (at k=%d)" % (max_grass_dim, (n-_sage_const_1 )//_sage_const_2 ))
    print()
...
for n in [_sage_const_2 , _sage_const_3 , _sage_const_4 ]:
    import math
    r = _sage_const_2 *n**_sage_const_2  - int(math.ceil(math.log2(n))) - _sage_const_1 
    dim_E = r - n**_sage_const_2 
    dim_ambient = n * (n**_sage_const_2  - _sage_const_1 ) * n
    # (210) matrix: source = r * n^2, target = binom(n^2,2) * n^2
    mat_rows = r * n**_sage_const_2 
    mat_cols = binomial(n**_sage_const_2 , _sage_const_2 ) * n**_sage_const_2 
    print("  M_%d: r=%d, dim(E')=%d, ambient=%d, (210) dual matrix: %d x %d" % (
        n, r, dim_E, dim_ambient, mat_rows, mat_cols))
    print("        weight-zero dim in sl_%d = %d" % (n, n-_sage_const_1 ))
    print("        max Gr parameter per site = %d" % ((n-_sage_const_1 )**_sage_const_2  // _sage_const_4 ))
