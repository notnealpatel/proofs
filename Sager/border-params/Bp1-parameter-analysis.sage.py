...
# This file was *autogenerated* from the file /workspace/Bp1-parameter-analysis.sage
from sage.all_cmdline import *   # import sage library

_sage_const_60 = Integer(60); _sage_const_2 = Integer(2); _sage_const_3 = Integer(3); _sage_const_4 = Integer(4); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_29 = Integer(29); _sage_const_15 = Integer(15); _sage_const_6 = Integer(6); _sage_const_7 = Integer(7)# Bp1: Detailed parameter analysis for M_4 border apolarity.
#
...
for n in [_sage_const_2 , _sage_const_3 , _sage_const_4 ]:
    num_pos_roots = n*(n-_sage_const_1 )//_sage_const_2 
    num_neg_roots = n*(n-_sage_const_1 )//_sage_const_2 
    dim_cartan = n - _sage_const_1 
    dim_sl = n**_sage_const_2  - _sage_const_1 
...
n = _sage_const_4 
r = _sage_const_29 
dim_Ep = r - n**_sage_const_2   # = 13
dim_sl4 = _sage_const_15 
num_pos_roots_sl4 = _sage_const_6 
...
upper_sets_by_size = {}
for sz in range(_sage_const_0 , _sage_const_7 ):
...
root_vals = {
    'r12': (_sage_const_2 , -_sage_const_1 , _sage_const_0 ),     # alpha_1
    'r23': (-_sage_const_1 , _sage_const_2 , -_sage_const_1 ),    # alpha_2
    'r34': (_sage_const_0 , -_sage_const_1 , _sage_const_2 ),     # alpha_3
    'r13': (_sage_const_1 , _sage_const_1 , -_sage_const_1 ),     # alpha_1 + alpha_2
    'r24': (-_sage_const_1 , _sage_const_1 , _sage_const_1 ),     # alpha_2 + alpha_3
    'r14': (_sage_const_1 , _sage_const_0 , _sage_const_1 )       # alpha_1 + alpha_2 + alpha_3
}

for sz in range(_sage_const_7 ):
    for S in upper_sets_by_size[sz]:
        # Roots NOT in S
        missing = [r for r in roots if r not in S]
        if not missing:
            cartan_dim = _sage_const_3   # No constraints
        else:
            # Build the constraint matrix: rows are root_vals for missing roots
            M = matrix(QQ, [[root_vals[r][i] for i in range(_sage_const_3 )] for r in missing])
            cartan_dim = _sage_const_3  - M.rank()
        ...
        if sz <= _sage_const_6  and cartan_dim > _sage_const_0  and sz > _sage_const_0 :  # Only print interesting cases
            param_max = (cartan_dim)**_sage_const_2  // _sage_const_4  if cartan_dim > _sage_const_1  else _sage_const_0 
            print("  S = %s (|S|=%d): Cartan freedom = %d" % (
                sorted(S), sz, cartan_dim))
            if cartan_dim > _sage_const_1 :
