...
gens = [
  (24) + (648)*x1*x1*x1 + (24)*x2*x2*x2 + (144)*x2*x2*x4 + (288)*x2*x4*x4 + (192)*x4*x4*x4,
  (-3/2) + (-6)*x2*x2*x2 + (18)*x2*x4*x4 + (-12)*x4*x4*x4,
  (-3/2) + (-6)*x2*x2*x2 + (18)*x2*x4*x4 + (-12)*x4*x4*x4,
  (-2) + (-96)*x0*x0*x1,
  (-2) + (-96)*x0*x0*x1,
  (-2) + (-96)*x0*x0*x1,
  ...
  (-3/2) + (-6)*x2*x2*x2 + (18)*x2*x4*x4 + (-12)*x4*x4*x4,
  (-3/2) + (-6)*x2*x2*x2 + (18)*x2*x4*x4 + (-12)*x4*x4*x4,
  (-3/4) + (6)*x2*x2*x2 + (-18)*x2*x2*x4 + (18)*x2*x4*x4 + (-6)*x4*x4*x4,
  (3/4) + (-6)*x2*x2*x2 + (18)*x2*x2*x4 + (-18)*x2*x4*x4 + (6)*x4*x4*x4,
  (1),
  (-1/2),
  (-3/2),
