...
gens = [
  (24) + (648)*x1*x1*x1 + (24)*x2*x2*x2 + (72)*x2*x2*x3 + (72)*x2*x2*x4 + (72)*x2*x3*x3 + (144)*x2*x3*x4 + (72)*x2*x4*x4 + (24)*x3*x3*x3 + (72)*x3*x3*x4 + (72)*x3*x4*x4 + (24)*x4*x4*x4,
  (-3/2) + (-6)*x2*x2*x2 + (18)*x2*x3*x4 + (-6)*x3*x3*x3 + (-6)*x4*x4*x4,
  (-3/2) + (-6)*x2*x2*x2 + (18)*x2*x3*x4 + (-6)*x3*x3*x3 + (-6)*x4*x4*x4,
  (-2) + (-96)*x0*x0*x1,
  (-2) + (-96)*x0*x0*x1,
  (-2) + (-96)*x0*x0*x1,
  ...
  (-3/2) + (-6)*x2*x2*x2 + (18)*x2*x3*x4 + (-6)*x3*x3*x3 + (-6)*x4*x4*x4,
  (-3/2) + (-6)*x2*x2*x2 + (18)*x2*x3*x4 + (-6)*x3*x3*x3 + (-6)*x4*x4*x4,
  (-3/4) + (6)*x2*x2*x2 + (-9)*x2*x2*x3 + (-9)*x2*x2*x4 + (-9)*x2*x3*x3 + (36)*x2*x3*x4 + (-9)*x2*x4*x4 + (6)*x3*x3*x3 + (-9)*x3*x3*x4 + (-9)*x3*x4*x4 + (6)*x4*x4*x4,
  (3/4) + (-6)*x2*x2*x2 + (9)*x2*x2*x3 + (9)*x2*x2*x4 + (9)*x2*x3*x3 + (-36)*x2*x3*x4 + (9)*x2*x4*x4 + (-6)*x3*x3*x3 + (9)*x3*x3*x4 + (9)*x3*x4*x4 + (-6)*x4*x4*x4,
  (1),
  (-1/2),
  (-3/2),
