...
gens = [
  (24) + (648)*x1*x1*x1 + (648)*x4*x4*x4,
  (-3/2),
  (-3/2),
  (-2) + (-96)*x0*x0*x1 + (72)*x2*x2*x4 + (144)*x2*x3*x4 + (72)*x3*x3*x4,
  (-2) + (-96)*x0*x0*x1 + (72)*x2*x2*x4 + (144)*x2*x3*x4 + (72)*x3*x3*x4,
  (-2) + (-96)*x0*x0*x1 + (72)*x2*x2*x4 + (144)*x2*x3*x4 + (72)*x3*x3*x4,
  (2) + (72)*x2*x2*x4 + (-144)*x2*x3*x4 + (72)*x3*x3*x4,
  (2) + (72)*x2*x2*x4 + (-144)*x2*x3*x4 + (72)*x3*x3*x4,
  (2) + (72)*x2*x2*x4 + (-144)*x2*x3*x4 + (72)*x3*x3*x4,
  (-3/2),
  (-3/2),
  ...
  (-2) + (-96)*x0*x0*x1 + (72)*x2*x2*x4 + (144)*x2*x3*x4 + (72)*x3*x3*x4,
  (1),
  (-1) + (64)*x0*x0*x0 + (24)*x2*x2*x2 + (72)*x2*x2*x3 + (72)*x2*x3*x3 + (24)*x3*x3*x3,
  (-1),
  (-1) + (64)*x0*x0*x0 + (24)*x2*x2*x2 + (72)*x2*x2*x3 + (72)*x2*x3*x3 + (24)*x3*x3*x3,
  (1),
  ((1)*sqrt3),
  (-1),
  (-1) + (24)*x2*x2*x2 + (-24)*x2*x2*x3 + (-24)*x2*x3*x3 + (24)*x3*x3*x3,
  (1),
  (-1) + (24)*x2*x2*x2 + (-24)*x2*x2*x3 + (-24)*x2*x3*x3 + (24)*x3*x3*x3,
  (-2) + (-96)*x0*x0*x1 + (72)*x2*x2*x4 + (144)*x2*x3*x4 + (72)*x3*x3*x4,
  (-1/2),
