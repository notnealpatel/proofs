...
TOY_FIXTURE = [
    ...
    {"id": [8, 3], "order": 8, "tier": "T1c", "action": "REJECT",
     "p_group": 2, "derived_cyclic": True, "derived_order": 2,
     "ceilings": {}, "ceiling": 0, "cd": [1, 2], "n_G": 2, "flags": []},
    {"id": [8, 4], "order": 8, "tier": "T1c", "action": "REJECT",
     "p_group": 2, "derived_cyclic": True, "derived_order": 2,
     "ceilings": {}, "ceiling": 0, "cd": [1, 2], "n_G": 2, "flags": []},
    ...
    {"id": [16, 3], "order": 16, "tier": "T2b", "action": "SURVIVE",
     "p_group": 2, "derived_cyclic": False, "derived_order": 4,
     "ceilings": {}, "ceiling": 2.828, "cd": [1, 2], "n_G": 2, "flags": []},
    {"id": [16, 6], "order": 16, "tier": "T1c", "action": "CAP(2)",
     "p_group": 2, "derived_cyclic": True, "derived_order": 2,
     "ceilings": {"T1c": 2.0}, "ceiling": 2.0, "cd": [1, 2], "n_G": 2, "flags": []},
