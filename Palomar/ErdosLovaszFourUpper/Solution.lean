...
/-- The independently stated family predicate agrees definitionally with
the repository predicate, for every ground type and parameter. -/
...
/-- The independently stated set of edge counts is the repository set. -/
...
identifies the package invariant with the existing invariant. -/
...
theorem erdosLovaszNum_four_le : erdosLovaszNum 4 ≤ 9 := by
  ...
  exact _root_.erdosLovaszNum_four_le
...
#check @Palomar.ErdosLovaszFourUpper.isErdosLovaszFamily_iff_source
#check @Palomar.ErdosLovaszFourUpper.erdosLovaszCards_eq_source
#check @Palomar.ErdosLovaszFourUpper.erdosLovaszNum_eq_source
#check @Palomar.ErdosLovaszFourUpper.erdosLovaszNum_four_le
#print axioms Palomar.ErdosLovaszFourUpper.erdosLovaszCards_four_nonempty
#print axioms Palomar.ErdosLovaszFourUpper.isErdosLovaszFamily_iff_source
#print axioms Palomar.ErdosLovaszFourUpper.erdosLovaszCards_eq_source
#print axioms Palomar.ErdosLovaszFourUpper.erdosLovaszNum_eq_source
