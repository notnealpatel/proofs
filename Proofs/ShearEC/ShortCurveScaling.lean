...
diagonal scaling proved here. Done in `ShearEC.VariableChangePointEquiv`
...
namespace ShearEC.ShortCurveScaling

open WeierstrassCurve.Affine
open ShearEC.ShearAdditionEC (shortCurve shortCurve_a₁ shortCurve_a₂ shortCurve_a₃)
