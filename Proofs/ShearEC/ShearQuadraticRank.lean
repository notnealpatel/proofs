...
`ShearEC.ShearAddition.singleShear` achieving it in one shear. Separations
...
namespace ShearEC.ShearQuadraticRank

open MvPolynomial ShearEC.ShearCircuit ShearEC.ShearCircuit.Circuit
...
can never separate — `ShearEC.ShearAddition.singleShear` realises it in one
...
end ShearEC.ShearQuadraticRank
