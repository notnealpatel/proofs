/-!
# Promoted to `Xlib.ShortCurveScaling`
...
* `Xlib.ShortCurveScaling.scaleEquiv` — the general unit-scaling
...
* `Xlib.ShortCurveScaling.congrCurve`, `congrCurve_Δ`,
  `congrCurve_isElliptic` — the congruent-number family, `Δ = 64n⁶`,
  ellipticity for `n ≠ 0`.
* `Xlib.ShortCurveScaling.congrCurveIso` — this file's main theorem as
