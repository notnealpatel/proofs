...
(`Xlib.FDRepBridge.charDegrees_eq_simpleModuleDims` +
`Xlib.CharDegreesComm.charDegrees_of_commGroup`).  Hence `W = ℂ·v` for an
...
namespace Xlib.CharDegreesIndexBound
...
end Xlib.CharDegreesIndexBound
